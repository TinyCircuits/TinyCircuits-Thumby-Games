# Alternative Font Handler
# Author: PanduhBeer
# Description: An alternative to Thumby's built in text functionality that will let you easily use a byte array as a font.
# This is set up for 3x3, but can be modified for any font you can make a byte array for. 
...
class FontHandler:
    def __init__(self):
        ...
        self.space = bytearray([0,0,0,0])
        self.colon = bytearray([0,5,0,0])
        # self.colon = bytearray([7,2,7,7])
        # FONT BITMAP: width: 144, height: 3 
        self.letters_white_raw = self.colon + self.space + bytearray([6,1,6,0,7,7,6,0,2,5,5,0,7,5,2,0,7,6,4,0,7,3,1,0,7,
        5,6,0,7,2,7,0,0,7,0,0,6,4,7,0,7,2,5,0,7,4,4,0,7,3,7,0,7,1,6,0,2,5,2,0,7,3,3,0,2,5,6,0,7,3,6,0,4,7,
        1,0,1,7,1,0,7,4,7,0,3,4,3,0,7,6,7,0,5,2,5,0,3,6,3,0,1,7,4,0,7,5,7,0,1,7,0,0,1,7,4,0,1,3,6,0,3,2,7,
        0,4,7,1,0,7,6,6,0,1,1,7,0,6,7,6,0,3,3,7,0])
        self.letters_raw = self.colon + self.space + bytearray([1,6,1,7,0,0,1,7,5,2,2,7,0,2,5,7,0,1,3,7,0,4,6,7,0,2,1,7,
        0,5,0,7,7,0,7,7,1,3,0,7,0,5,2,7,0,3,3,7,0,4,0,7,0,6,1,7,5,2,5,7,0,4,4,7,5,2,1,7,0,4,1,7,3,0,6,7,6,
        0,6,7,0,3,0,7,4,3,4,7,0,1,0,7,2,5,2,7,4,1,4,7,6,0,3,7,0,2,0,7,6,0,7,7,6,0,3,7,6,4,1,7,4,5,0,7,3,0,
        6,7,0,1,1,7,6,6,0,7,1,0,1,7,4,4,0,7])
...
# These are the two functions that will replace thumby.drawText
