...
async def main():
	...
	#classes
	class Card:
	    def __init__(self, _init_x, _init_y, _owner, _num, _suit):
	        self.x = _init_x
	        self.y = _init_y
	        self.hold = True
	...
	#SHARED FUNCTIONS
	def drawSprite( inspr, x, y, width, height, mirrorX:bool, mirrorY:bool, key, frame = 0, masked = False):
	    sprite = []
	...
	def drawPassOutCards():
	    nonlocal card_passing_out_animation
	    nonlocal TempCX
	    nonlocal TempCY
	    nonlocal game_location
	    nonlocal hand
