...
async def main():
	...
	while(1):
	    ...
	    if (gamePlay == False and lose == False):
	        ...
	        if(await thumby.buttonA.pressed() == True or await thumby.buttonB.pressed() == True):
	            gamePlay = True
	        ...
	        if (await thumby.buttonL.pressed() == True and padSprite.x > 0 ):
	            padSprite.x -= 1
	        if (await thumby.buttonR.pressed() == True and padSprite.x < 62 ): # 72 - width of ball paddle Sprite (10)
	            padSprite.x += 1
	        ...
	        if(await thumby.buttonA.pressed() == True):
	            machine.reset() 
