...
async def main():
	...
	while(await thumby.buttonA.pressed() == True or await thumby.buttonB.pressed() == True):
	    ...
	    await thumby.display.update()
	    pass
	while(await thumby.buttonA.pressed() == False and await thumby.buttonB.pressed() == False):
	    if(time.ticks_ms() % 1000 < 500):
	        thumby.display.drawFilledRectangle(0, 32, 72, 8, 0)
	        thumby.display.drawText("Press A/B", 0, 32, 1)
	    else:
	...
	while(GameRunning == True):
	    ...
	    if(await thumby.buttonR.pressed() == True):
	        ...
	        direction = 4
	        thumby.audio.set(thrusterFreq)
	    elif(await thumby.buttonU.pressed() == True):
	        direction = 0
	        thumby.audio.set(thrusterFreq)
	    ...
	    if(direction == 0):
	        ...
	        if(await thumby.buttonU.pressed() == True):
	            ...
	            YVel -= Accel
	        if(await thumby.buttonB.pressed() == True and ReloadTimer == 0):
	        ...
	        XMirror = False
	        YMirror = False
	        if(await thumby.buttonU.pressed() == True and await thumby.buttonR.pressed() == True):
	            if(t0 % AnimTime < AnimTime / 2):
	        ...
	        XMirror = False
	        YMirror = True
	        if(await thumby.buttonR.pressed() == True and await thumby.buttonD.pressed() == True):
	            if(t0 % AnimTime < AnimTime / 2):
	                CurSpr = UpRightMovingFrame1
	            else:
	                CurSpr = UpRightMovingFrame2
	        ...
	        XMirror = False
	        YMirror = True
	        if(await thumby.buttonD.pressed() == True):
	            if(t0 % AnimTime < AnimTime / 2):
	                CurSpr = UpMovingFrame1
	            else:
	                CurSpr = UpMovingFrame2
	        ...
	        XMirror = True
	        YMirror = True
	        if(await thumby.buttonD.pressed() == True and await thumby.buttonL.pressed() == True):
	            if(t0 % AnimTime < AnimTime / 2):
	                CurSpr = UpRightMovingFrame1
	            else:
	                CurSpr = UpRightMovingFrame2
	        ...
	        XMirror = True
	        YMirror = False
	        if(await thumby.buttonL.pressed() == True):
	            if(t0 % AnimTime < AnimTime / 2):
	                CurSpr = RightMovingFrame1
	            else:
	                CurSpr = RightMovingFrame2
	        ...
	        XMirror = True
	        YMirror = False
	        if(await thumby.buttonU.pressed() == True and await thumby.buttonL.pressed() == True):
	            if(t0 % AnimTime < AnimTime / 2):
	                CurSpr = UpRightMovingFrame1
	            else:
	                CurSpr = UpRightMovingFrame2
	    ...
	    elif(await thumby.buttonU.pressed() == False and await thumby.buttonD.pressed() == False and await thumby.buttonL.pressed() == False and await thumby.buttonR.pressed() == False):
	        thumby.audio.stop()
