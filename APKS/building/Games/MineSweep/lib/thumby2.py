	...
	class Sprite:
	    ...
	    async def __init__(self,blit:ptr8,width,height):
	        self.blit=blit
	        self.width=width
	        self.height=height
	...
	class Buffer:
	    ...
	    async def __init__(self,buffer:ptr8,width,height):
	        self.buffer=buffer
	        self.width=width
	        self.height=height
	    ...
	    def drawLineH(self,x1,y,x2,color):
	        ww=int(self.width)
	        hh=int(self.height)
	        if 0<=y<hh:
	    ...
	    def drawLineV(self,x,y1,y2,color):
	        ww=int(self.width)
	        hh=int(self.height)
	        if 0<=x<ww:
	    ...
	    def _blit(self,sprite:ptr8,x,y,width,height,
	            key,mirrorX,mirrorY):
	        ww=int(self.width)
	        hh=int(self.height)
	...
	class Font:
	    ...
	    async def __init__(self,fontFile,charW,charH,spacingX,spacingY):
	...
	class TextBuffer:
	    ...
	    async def __init__(self,screen,font):
	        self.screen=screen
	        self.font=font
	
	    
	    def _printXY(self,text,x,y,color):
	...
	class ThumbyDisplayBuffer(Buffer):
	    ...
	    async def __init__(self):
	        super().aawait wait __init__(thumby.display.display.buffer,72,40)
	...
	class buttons:
	    ...
	    @staticmethod
	    async def wait(activeButtons=None):
	...
	async def update():
	    display.show()
	    buttons.aawait wait update()
	    return display.await waitFrame()
	
	async def requireMinThumbyVersion(reqVersion):
