	...
	class Player:
	    ...
	    async def levelUpCheck(self):
	        ...
	        if self.playerBlock['experience'] >= self.playerBlock['trainerLevel'] * 2:
	            ...
	            await thingAquired(self.playerBlock['name'], "Your Trainer", "Level Is", "Now " + str(self.playerBlock['trainerLevel']), 2)
	            if self.playerBlock['trainerLevel'] % 10 == 0 and self.playerBlock['friendMax'] < 5:
	                ...
	                await thingAquired(self.playerBlock['name'], "can now", "have " + str(self.playerBlock['friendMax']), "monsters!", 2)
