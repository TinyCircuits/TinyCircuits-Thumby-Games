...
async def main():
	...
	while(1):
	    ...
	    if tm<200:
	        ...
	        #speed
	        if await thumby.buttonU.pressed(): rs=7
	        else: rs=1
	        #invert
	        if await thumby.buttonA.pressed(): inv=0; #top red button
	        else: inv=1
	        #freeze rotation
	        if await thumby.buttonB.pressed(): frz=1
	        else: frz=0
	        if await thumby.buttonD.pressed(): prd=1
	        else: prd=0        
