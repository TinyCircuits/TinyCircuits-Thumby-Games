...
async def main():
	...
	def reset_players():
	    nonlocal pac, ghost_1, ghost_2, ghost_3, ghosts, ghost_entering, ghost_multiplier
	    pac = pico_pac()
	    ghost_1 = ghost_class()
	    ghost_2 = ghost_class()
	    ghost_3 = ghost_class()
	...
	def reset_balls():
	    nonlocal ball_array, balls_eaten, power_ball_1, power_ball_2, power_time
	...
	def init_state():
	    nonlocal player_lives, player_score, ghost_speed, level, ghost_state, extra_life_score, maze_index
	    player_lives = 3
	    player_score = 0
	...
	def eat_balls():
	    nonlocal ball_array, player_score, balls_eaten
	    x = 0
	    y = -1
	    array_x = -1
	    array_y = -1
	...
	def eat_power_balls():
	    nonlocal power_time, power_ball_1, power_ball_2
	    p_time = 150
