...
async def main():
	...
	# Please take a look at Journey3Dg_await main.py for the await main() attraction
	...
	if emu_check():
	    if version_check():
	        ...
	        exec('''
	from Games.Journey3Dg.Journey3Dg_await main import await main
	await main(fade_out)
	''', {'fade_out': fade_out})
	
	        end()
	
	    if __name__ != '__await main__':
	        soft_reset()
