	...
	def create_level_elements(current_y_pos):
		nonlocal hazards_left
		nonlocal hazards_right
		nonlocal background_elements
		nonlocal wall_elements_left
		nonlocal wall_elements_right
		nonlocal last_generation_height
	...
	def SwitchState(state):
		...
		nonlocal time_since_last_state_change
	...
	def init_state(game_interface):
		...
		nonlocal hazards_left
		nonlocal hazards_right
		nonlocal player_size
		nonlocal player_pos
		nonlocal player_vel
		nonlocal player_rect
		nonlocal key_pressed_start_time
		nonlocal jump_start_time
		nonlocal grab_start_time
		nonlocal full_jump_chain
		nonlocal is_boosting
		nonlocal last_boost_particle_gen_time
		nonlocal last_blink_start
		nonlocal last_score
		nonlocal time_since_last_state_change
		nonlocal is_grounded
		nonlocal time_since_grounded
		nonlocal last_generation_height
	...
	def game_loop(key_pressed, delta_time, game_interface):
		...
		nonlocal last_score
		nonlocal time_since_last_state_change
		nonlocal current_fps_index
		nonlocal fps_list
		nonlocal is_grounded
		nonlocal time_since_grounded
		nonlocal time_since_game_start
		nonlocal save_data
