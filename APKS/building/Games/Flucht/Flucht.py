...
async def main():
	...
	while True:
		...
		pressed = await thumby.buttonA.pressed() or await thumby.buttonB.pressed() or await thumby.buttonU.pressed() or await thumby.buttonD.pressed() or await thumby.buttonL.pressed() or await thumby.buttonR.pressed()
