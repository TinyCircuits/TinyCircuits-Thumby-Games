...
gc.enable()
box = (0,254,254,254,254,254,254,254,254,254,254,254,254,254,254,0,
...
def singleplayer_battle(char, enemy_char, config):
    def character_move(name, jumpheight, attack, health, speed, weight, player_type, state, x, y, direction, a_x, a_y, a_jumpheight, a_attack, a_health, a_speed, a_weight, cooldown, knockback_state, trident_data, config):
        goggles_walk_sprite = (243,245,246,150,98,108,142,158,110,108,130,22,246,245,243,255,
               255,255,255,191,222,101,155,155,99,93,126,255,255,255,255,255)
        goggles_icon = (243,245,246,6,146,108,110,158,158,108,98,22,246,245,243,255,
                    255,255,255,255,254,253,251,251,251,253,254,255,255,255,255,255)
        goggles_attack_1 = (243,245,246,6,146,108,110,158,158,108,98,22,246,245,243,255,
                255,255,255,191,222,101,155,155,99,221,238,239,199,171,171,255)
        goggles_attack_2 = (243,245,246,6,146,108,110,158,158,108,98,22,246,245,243,255,
                255,255,255,191,222,101,155,155,99,221,238,239,199,171,199,255)
        gogglesattackupper = (243,245,246,6,146,108,110,158,158,108,98,22,246,245,115,255,
                255,255,255,191,222,101,155,155,99,221,238,247,249,242,245,250)
        goggles_trident_side = (119,119,119,119,99,85,85)
        goggles_trident_up = (127,120,119,0,119,112,127)
        zap_walk = (231,231,251,253,27,231,247,119,87,111,31,255,255,255,255,255,
           255,255,255,255,255,254,85,129,85,254,255,255,255,255,255,255)
        zap_hit = (231,231,251,253,27,231,247,247,215,239,31,255,255,255,255,255,
           255,255,255,255,255,254,253,253,253,254,245,251,213,239,151,223)
        zap_attack_1 = (231,231,251,253,27,231,247,119,87,111,31,255,255,255,255,255,
               255,255,255,255,255,254,85,129,85,250,251,253,255,255,255,255)
        zap_attack_2 = (255,255,255,255,255,255,255,63,223,239,239,111,207,55,199,199,
               255,255,255,255,255,255,87,130,85,250,249,251,253,254,255,255)
        zap_attack_upper_frame_1  = (231,231,251,253,27,231,247,119,87,111,31,255,255,255,255,255,
               255,253,251,247,247,246,85,129,85,246,247,247,251,253,254,255)
        zap_attack_upper_frame_2 = (231,231,251,253,27,103,87,119,87,111,31,255,255,255,255,255,
               255,253,251,247,247,246,85,129,85,246,247,247,251,253,254,255)
        apex_icon = (63,222,237,51,219,109,245,245,245,245,109,219,51,237,222,63,
           120,183,207,216,183,108,95,95,95,95,108,183,216,207,183,120)
        apex_walk = (63,222,237,51,219,109,245,245,245,245,109,219,51,237,222,63,
           120,183,207,216,183,108,95,95,95,95,108,183,216,207,183,120)
        apex_walk_1 = (63,222,237,51,219,109,245,245,245,245,109,219,51,237,222,63,
           120,183,207,216,183,108,95,95,95,95,108,183,216,207,183,120)
        apex_walk_2 = (63,222,237,51,219,237,245,181,181,181,237,219,51,237,222,63,
           120,183,207,216,183,111,95,91,91,91,111,183,216,207,183,120)
        apex_walk_3 = (63,222,237,51,219,237,181,181,181,245,237,219,51,237,222,63,
           120,183,207,216,183,111,91,91,91,95,111,183,216,207,183,120)
        apex_walk_4 = (63,222,237,51,219,237,245,245,245,245,237,219,51,237,222,63,
           120,183,207,216,183,111,88,95,95,88,111,183,216,207,183,120)
        apex_attack_1 = (63,222,237,51,219,173,117,245,245,117,173,219,51,237,222,63,
           120,183,207,216,183,111,87,88,88,87,111,183,216,207,183,120)
        apex_attack_2 = (63,222,237,51,219,237,245,21,21,245,237,219,51,237,222,20,
           120,183,207,216,183,111,95,82,82,95,111,183,216,207,183,120)
        blobbo_walk_1 = (255,255,255,251,59,219,235,235,235,235,219,59,251,251,255,255,
           255,255,255,224,223,189,183,183,183,183,189,223,224,255,255,255)
        blobbo_walk_2 = (255,255,255,255,127,127,191,191,191,191,127,127,255,255,255,255,
           255,255,225,222,223,187,175,175,175,175,187,223,222,225,255,255)
        
        # BITMAP: width: 32, height: 8
        # BITMAP: width: 32, height: 8
        charge_beam_right = (126,189,195,239,247,239,247,239,247,239,247,239,247,239,247,239,247,239,247,239,247,239,247,239,247,239,247,239,247,239,247,239)
        line_1 = (255,135,255,129,255,135,255,129)
        line_2 = (255,129,255,135,255,129,255,135)
        waves = (189,219,231,255,189,219,231,255)
        # BITMAP: width: 20, height: 20
        waves_2 = (127,143,241,254,127,143,241,254,255,255,255,255,254,241,143,127,254,241,143,127,
                ...
                if direction == 'Right':
                    ...
                    for i in range(16):
                        if x + i == a_x:
                            for j in range(16):
                                if y + j == a_y:
                                    hitdata = hit(15, weight, 25, 35, direction, a_x, a_y, a_health)
                                    a_x = hitdata[0]
                                    a_y = hitdata[1]
                                    a_health = hitdata[2]
                                    is_hit = True
            ...
            if AU_Pressed == True and trident_data == None and cooldown == 0:
                ...
                if direction == 'Right':
                    ...
                    if in_range == True:
                        ...
                        i = 0
                    for i in range(4):
                        thumby.display.blit(waves, x*i, y+10, 8, 8, 1)
                else:
                    is_flipped_x = True
                    current_sprite = goggles_attack_2
                    state = 'attack_2_left'
                    ...
                    i = 0
                    for i in range(4):
                        thumby.display.blit(waves, x*-1*i, y+10, 8, 8, 1)
            if trident_data != None:
                trident_hit = False
                trident_sprite = goggles_trident_up
                trident_flipped_x, trident_flipped_y = False, False
                print(trident_data, a_x, a_y)
                if trident_data[0] > a_x:
                    trident_data[0] -= 2
                    trident_data[2] = 'Left'
                elif trident_data[0] < a_x:
                    trident_data[0] += 2
                    trident_data[2] = 'Right'
                elif trident_data[1] < a_y:
                    trident_data[0] -= 2
                    trident_data[2] = 'Down'
                elif trident_data[1] > a_y:
                    trident_data[0] += 2
                    trident_data[2] = 'Up'
                if trident_data[2] == 'Up':
                    trident_sprite = goggles_trident_up
                    trident_data[1] += 2
                elif trident_data[2] == 'Left':
                    trident_sprite = goggles_trident_side
                    trident_flipped_y = True
                elif trident_data[2] == 'Right':
                    trident_sprite = goggles_trident_side
                elif trident_data[2] == 'Down':
                    trident_sprite = goggles_trident_up
                    trident_flipped_x = True
                for i in range(16):
                    if trident_data[0] + i == a_x or trident_data[0] - i == a_x:
                        for j in range(16):
                            if trident_data[1] + j == a_y or trident_data[1] - j == a_y:
                                trident_hit = True
                if trident_hit == True:
                    a_health -= 20
                if trident_data != None:
                    thumby.display.drawSprite(trident_sprite, trident_data[0], trident_data[1], 7, 7, trident_flipped_x, trident_flipped_y, 1)
                    trident_data[3] += 1
                    if trident_data[3] <= 50:
                        trident_data[3] += 1
                    else:
                        trident_data = None
            if R_Pressed == True:
        ...
        #Apex Code
            ...
            if R_Pressed == True or L_Pressed == True:
                ...
                thumby.display.blit(waves_2, x-3, y-5, 20, 20, 1)
                for i in range(24):
                        if x + i == a_x:
                            for j in range(16):
                                if y - j == a_y:
        ...
        if y > 100:
            ...
            a_health = 0
        thumby.display.drawSprite(current_sprite, x, y, 16, 16, is_flipped_x, is_flipped_y, 1)         
        #end game code
    ...
    while battling == True:
        thumby.display.fill(1)
        thumby.display.rect(0, 36, 100, 2, 0)
...
def main_menu():
     ...
     def config_menu():
         ...
         b_button = (15,247,251,253,14,174,174,94,253,251,247,15,
           15,14,13,11,6,6,6,7,11,13,14,15)
         slider = (127,99,93,0,93,99,127)
         configmenu = True
         menu_arrow = (31,31,0,17,27)
         menu = True
         arrow_location = 0
         while configmenu == True:
             ...
             if arrow_location == 0:
                 thumby.display.blit(menu_arrow, 15, 0, 5, 5, 1)
             elif arrow_location == 1:
                thumby.display.blit(menu_arrow, 15, 8, 5, 5, 1)
             elif arrow_location == 2:
                thumby.display.blit(menu_arrow, 15, 16, 5, 5, 1)
             time.sleep(0.1)
             if thumby.buttonA.pressed() and arrow_location == 0:
                 ...
                 while ai_config_menu == True:
                     ...
                     thumby.display.rect(5, 10, 25, 2, 0)
                     thumby.display.rect(5, 30, 7, 2, 0)
                     thumby.display.blit(slider, ai_stupidity+5, 10, 7, 7, 1)
                     thumby.display.blit(slider, ai_mode+5, 30, 7, 7, 1)
                 ...
                 while gameplay_config_menu == True:
                     ...
                     thumby.display.rect(1, 15, 10, 2, 0)
                     thumby.display.blit(slider, game_pace, 15, 7, 7, 1)
                     thumby.display.drawText('Wall Behavior:', 5, 25, 0)
                     thumby.display.rect(1, 30, 10, 2, 0)
                     thumby.display.blit(slider, wall_int*3, 30, 7, 7, 1)
     ...
     while menu == True:
         ...
         if arrow_location == 0:
             thumby.display.blit(menu_arrow, 15, 20, 5, 5, 1)
         elif arrow_location == 1:
            thumby.display.blit(menu_arrow, 15, 30, 5, 5, 1)
...
def character_select(config):
    ...
    while select_screen == True:
        ...
        goggles_icon = (243,245,246,6,146,108,110,158,158,108,98,22,246,245,243,255,
                255,255,255,255,254,253,251,251,251,253,254,255,255,255,255,255)
        goggles_icon_selected  = (12,10,9,249,109,147,145,97,97,147,157,233,9,10,12,0,
               0,0,0,0,1,2,4,4,4,2,1,0,0,0,0,0)
        # BITMAP: width: 16, height: 16
        zap_icon = (251,55,207,111,183,119,247,247,247,119,183,111,215,55,251,251,
                255,240,239,223,190,63,95,7,95,63,190,223,239,240,255,255)
        
        # BITMAP: width: 16, height: 16
        zap_icon_selected = (4,200,48,144,72,136,8,8,8,136,72,144,40,200,4,4,
                0,15,16,32,65,192,160,248,160,192,65,32,16,15,0,0)
        apex_icon = (63,222,237,51,219,109,245,245,245,245,109,219,51,237,222,63,
           120,183,207,216,183,108,95,95,95,95,108,183,216,207,183,120)
        # BITMAP: width: 16, height: 16
        apex_icon_selected = (192,33,18,204,36,146,10,10,10,10,146,36,204,18,33,192,
           135,72,48,39,72,147,160,160,160,160,147,72,39,48,72,135)
        # BITMAP: width: 16, height: 16
        blobbo_icon = (255,255,255,251,59,219,235,235,235,235,219,59,251,251,255,255,
           255,255,255,224,223,189,183,183,183,183,189,223,224,255,255,255)
        # BITMAP: width: 16, height: 16
        blobbo_icon_selected = (0,0,0,4,196,36,20,20,20,20,36,196,4,4,0,0,
