...
PlayerSpr = bytearray([0,126,66,90,90,66,126,0,255,255,255,255,255,255,255,255])

PlayerRunFrame1 = bytearray([0,126,66,90,90,66,126,0,255,255,255,255,255,255,255,255])

PlayerRunFrame2 = bytearray([231,219,165,90,90,165,219,231,255,255,255,255,255,255,255,255])
CactusSpr1 = bytearray([63,95,111,119,111,95,63,255,255,255,255,255,255,255,255,255])
CactusSpr2 = bytearray([31,103,121,126,121,103,31,255,255,255,255,255,255,255,255,255])
...
thumby.display.drawText("Geometry", 12, 0, 1)
thumby.display.drawText(" Dash", 15, 9, 1)
thumby.display.update()

thumby.display.setFPS(60)

thumby.saveData.setName("GeometryDash")
...
while(GameRunning):
    ...
    if(CactusPos < 3 and CactusPos > -8 and YPos > -8):
    ...
    if(CactusPos < -24):
        ...
        CactusPos = random.randint(72, 180)
